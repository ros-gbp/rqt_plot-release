...
Requires:       ros-melodic-qt-gui-py-common >= 0.2.25
Requires:       ros-melodic-qwt-dependency
...
%changelog
* Thu Mar 14 2019 Dirk Thomas <dthomas@osrfoundation.org> - 0.4.9-0
